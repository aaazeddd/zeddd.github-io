function update() {
    ...
    var masuk               = new Date().setHours(7, 20, 0, 0)
    var mulaiBreak          = new Date().setHours(9, 0, 0, 0)
    var selesaiBreak        = new Date().setHours(9, 15, 0, 0)
    var mulaiIstirahat      = new Date().setHours(11, 45, 0, 0)
    var selesaiIstirahat    = new Date().setHours(12, 30, 0, 0)
    var pulang              = new Date().setHours(15, 20, 0, 0)
