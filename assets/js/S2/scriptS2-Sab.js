function update() {
    ...
    var mulaiBreak          = new Date().setHours(15, 15, 0, 0)
    var selesaiBreak        = new Date().setHours(15, 30, 0, 0)
    var mulaiIstirahat      = new Date().setHours(17, 30, 0, 0)
    var selesaiIstirahat    = new Date().setHours(18, 15, 0, 0)
    var pulang              = new Date().setHours(19, 15, 0, 0)
